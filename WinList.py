...
Classic_Winlists = [
    ...
    [0, 0, 0, 1, 3, 12, 125, "Jackpot support not added yet"], #c_spot7_WinList
    [0, 0, 0, 0, 2, 7, 60, 675, "Jackpot support not added yet"], #c_spot8_WinList
    [0, 0, 0, 0, 1, 5, 20, 210, 2500, "Jackpot support not added yet"], #c_spot9_WinList
    [0, 0, 0, 0, 1, 2, 6, 50, 580, 10000, "Jackpot support not added yet"], #c_spot10_WinList
...
MegaMillion_Winlists = [
    ...
    [0, 0, 0, 2, 6, 20, 280, "Jackpot support not added yet"], #mm_spot7_WinList
    [0, 0, 0, 1, 2, 10, 100, 1280, "Jackpot support not added yet"], #mm_spot8_WinList
    [0, 0, 0, 1, 2, 6, 20, 300, 5200, "Jackpot support not added yet"], #mm_spot9_WinList
    [0, 0, 0, 0, 2, 4, 7, 50, 600, 11000, "Jackpot support not added yet"], #mm_spot10_WinList
